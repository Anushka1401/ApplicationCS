...
public class ViewingAdmin extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_viewing_admin);
    ...
    private void addData() {
        ...
        db.collection("Users")
                .whereEqualTo("isAdmin", "1")//looks for the corresponding value with the field
                // in the database
                .get()
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            for (DocumentSnapshot document : task.getResult()) {
                                ...
                                if (String.valueOf((CharSequence) document.get("uId")).equals(current)) {

                                } else {

                                    //opslist.append("\n Operator Name: " +(CharSequence) document.get("FullName"));
                                    list.add(new ModelAdmin(R.drawable.dp2, String.valueOf((CharSequence) document.get("FullName")),
                                    ...
                                    adapter = new AdapterAdmin(ViewingAdmin.this, list, list.size());
